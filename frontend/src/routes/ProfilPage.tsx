...
function ProfileContent() {
  ...
  useEffect(() => {
    ...
    getCurrentUser(auth.tokens.access)
      ...
      .catch(() => setMessage("Le profil est temporairement indisponible."));
  }, []);
